...
map.getView().fit([-10459245.354818, 1854955.542999, -9534247.154789, 2452906.662099], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Puntos de Transporte Campeche</h2>';
        return titleElement;
    })(),
